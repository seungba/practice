...
public class MainClass {
	...
	public static void main(String[] args) {
		...
		int[] score = new int[5];
		Scanner scanner = new Scanner(System.in); // 입력받기를 기다리는중
		...
		// 기본 자료형 데이터를 담고있는 변수와 달리 배열변수는 배열 데이터의 주소를 담고있다.
		...
		// 배열 길이
		System.out.println("arrAtt1.length : " + arrAtt1.length); // 배열의 길이 6

		// 배열 요소 출력
		System.out.println("arrAtt1 : " + Arrays.toString(arrAtt1));

		// 배열 요소 복사
		arrAtt3 = Arrays.copyOf(arrAtt1, arrAtt1.length); // arrAtt3 에 arrAtt1의 값을 복사
		System.out.println("arrAtt3 : " + Arrays.toString(arrAtt3));

		// 배열 레퍼런스
		arrAtt2 = arrAtt1;
		System.out.println("arrAtt1 : " + arrAtt1); // 값은 같을지언정 배열 1과 배열 3의 주소는 다르다
		System.out.println("arrAtt2 : " + arrAtt2); // 배열 1과 배열 2는 같은곳을 바라보고 있는 레퍼런스이다.
